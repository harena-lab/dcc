...
cell-width="20" cell-height="20" background-color="#dddddd" cover-image="images/photo/lactiferous-duct.jpg" cover-opacity="100" grid analysis>
yyyyyyyyyyyyyyyyyyyyyyyyyrryyyyyyyyyyyyy
yyyyyyyyyyyyyyyyyyyyyyyyr__ryyyyyyyyyyyy
yyyyyyyyyyyyyyyyyyyyyyyyr__ryyyyyyyyyyyy
yyyyyyyyyyyyyyrryyyyyyyyyrryyyyyyyyyyyyy
yyyyyyyyyyyyyr__ryyyyyyyyyyyyyyyyyyyyyyy
yyyyyyyyyyyyyr__ryyyyyyyyyyyyyyyyyyyyyyy
yyyyyyyyyyyyyyrryyyyyyyyyyyyyyyyyyyyyyyy
yyyyyyyyyyyyyyyyybbbbbbbyyyryyyyyyyyyyyy
yyyyyyyyyyyyyyyybb11111bbyr_ryyyyyyyyyyy
yyyyyyyyyyyyyyybb1111111byr_ryyyyyyyyyyy
yyyyyyyyyyyyyybb11____11byyryyyyyyyyyyyy
yyyyyyyyyyyyybb11_____11byyyyyyyyyyyyyyy
yyyyyyyyyyyyyb11______11byyyyyyyyyyyyyyy
yyyyyyyyyyyyyb11______11byyyyyyyyyyyyyyy
yyyyyyyyyyyyyb11______11byyyyyyyyyyyyyyy
yyyyyyyyyyyyyb11______11byyyyyyyyyyyyyyy
yyyyyyyyyyyyyb11_____11bbyyyyyyyyyyyyyyy
yyyyyyyyyyyyybb11___11bbyyyyyyyyyyyyyyyy
yyyyyyyyyyyyyybb11111bbyyyyyyyyyyyyyyyyy
yyyyyyyyyyyyyyybb111bbyyyyyyyyyyyyyyyyyy
yyyyyyyyyyyyyyyybbbbbyyyyyyyyyyyyyyyyyyy
...
<dcc-cell-image type="." label="vazio" image="images/cell/cell-gray.svg"></dcc-cell-image>
<dcc-cell-image type="1" label="cell1" image="images/cell/cell-1.png"></dcc-cell-image>
<dcc-cell-image type="3" label="cell3" image="images/cell/cell-3.png"></dcc-cell-image>
<dcc-cell-image type="5" label="cell5" image="images/cell/cell-5.png"></dcc-cell-image>
...
`<div style="flex:36px; max-height:36px; display:flex; flex-direction:row">
   <img src="images/cell/cell-1-double.png" style="flex:10%; max-width:72px; max-height:36px">
   &nbsp;
...
<hr><div style="flex:36px; max-height:36px; display:flex; flex-direction:row">
   <img src="images/cell/cell-1-dies.png" style="flex:10%; max-width:72px; max-height:36px">
   &nbsp;
   <div style="flex:40%; max-height:48px; margin-right:10px; font-size: 2vh">
...
<hr><div style="flex:36px; max-height:36px; display:flex; flex-direction:row">
   <img src="images/cell/cell-1-mutate-cell-3.png" style="flex:10%; max-width:72px; max-height:36px">
   &nbsp;
   <div style="flex:40%; max-height:48px; margin-right:10px; font-size: 2vh">
...
<hr><div style="flex:36px; max-height:36px; display:flex; flex-direction:row">
   <img src="images/cell/cell-3-double.png" style="flex:10%; max-width:72px; max-height:36px">
   &nbsp;
   <div style="flex:40%; max-height:48px; margin-right:10px; font-size: 2vh">
...
<hr><div style="flex:36px; max-height:36px; display:flex; flex-direction:row">
   <img src="images/cell/cell-3-dies.png" style="flex:10%; max-width:72px; max-height:36px">
   &nbsp;
   <div style="flex:40%; max-height:48px; margin-right:10px; font-size: 2vh">
...
<hr><div style="flex:36px; max-height:36px; display:flex; flex-direction:row">
   <img src="images/cell/cell-3-mutate-cell-5.png" style="flex:10%; max-width:72px; max-height:36px">
   &nbsp;
   <div style="flex:40%; max-height:48px; margin-right:10px; font-size: 2vh">
...
<hr><div style="flex:36px; max-height:36px; display:flex; flex-direction:row">
   <img src="images/cell/cell-5-double.png" style="flex:10%; max-width:72px; max-height:36px">
   &nbsp;
   <div style="flex:40%; max-height:48px; margin-right:10px; font-size: 2vh">
...
<hr><div style="flex:36px; max-height:36px; display:flex; flex-direction:row">
   <img src="images/cell/cell-5-dies.png" style="flex:10%; max-width:72px; max-height:36px">
   &nbsp;
   <div style="flex:40%; max-height:48px; margin-right:10px; font-size: 2vh">
...
<hr><div style="flex:36px; max-height:36px; display:flex; flex-direction:row">
   <img src="images/cell/cell-5-moves.png" style="flex:10%; max-width:72px; max-height:36px">
   &nbsp;
   <div style="flex:40%; max-height:48px; margin-right:10px; font-size: 2vh">
