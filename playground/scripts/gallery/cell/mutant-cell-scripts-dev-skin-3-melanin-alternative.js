(function () {
  AuthorCellManager.instance.insertSource(
    ...
    [['empty', '_', { src: 'images/cell/cell-yellow-green.png', width: 25, height: 25, alt: 'empty' }],
     ['stage-1', '1', { src: 'images/cell/quera-1.png', width: 25, height: 25, alt: 'stage-1' }],
     ['stage-2', '2', { src: 'images/cell/quera-2.png', width: 25, height: 25, alt: 'stage-2' }],
     ['stage-3', '3', { src: 'images/cell/quera-3.png', width: 25, height: 25, alt: 'stage-3' }],
     ['stage-4', '4', { src: 'images/cell/quera-4.png', width: 25, height: 25, alt: 'stage-4' }],
...
`<dcc-space-cellular-editor id="cellular-space" rows="28" cols="40"
  cell-width="20" cell-height="20" cover-image="images/photo/epidermis-dermis.jpg" cover-opacity="100" grid analysis policy="crescent">
</dcc-space-cellular-editor>

<dcc-cell-image type="1" label="stage-1" image="images/cell/quera-1.png"></dcc-cell-image>
<dcc-cell-image type="2" label="stage-2" image="images/cell/quera-2.png"></dcc-cell-image>
<dcc-cell-image type="3" label="stage-3" image="images/cell/quera-3.png"></dcc-cell-image>
<dcc-cell-image type="4" label="stage-4" image="images/cell/quera-4.png"></dcc-cell-image>
